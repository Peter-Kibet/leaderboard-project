...
**[Leaderboard]** is a project where you can view scores submitted by different players and submit your own score. The project utilizes the Leaderboard API service to store and retrieve the data. This is an ongoing project that requires further development, but progress is being made!
...
This will start the webpack dev server and launch the project in your default browser.
...
This will create a optimized and minified version of the project in the dist directory.
